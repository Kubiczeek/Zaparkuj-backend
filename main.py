...
@app.get("/api/v1/parking-occupancy/{directory}")
async def say_hello(directory: str, credentials: Annotated[HTTPBasicCredentials, Depends(is_authorized)], conf: float = 0.3):
